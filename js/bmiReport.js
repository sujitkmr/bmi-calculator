...
function generateBMIReport() {
  ...
  doc.setFont("helvetica", "normal");
  doc.text(`Weight: ${weight} kg`, 50, y);
  y += lineGap;
  doc.text(`Skeletal Muscle Mass: ${muscleMass} kg`, 50, y);
  y += lineGap;
  doc.text(`Body Fat Mass: ${fatMass} kg`, 50, y);
  y += lineGap + 5;
  ...
  doc.setFont("helvetica", "normal");
  doc.text(`Target Weight: ${targetWeight} kg`, 50, y);
  y += lineGap;
  doc.text(`Weight to Reduce: ${weightControl} kg`, 50, y);
  y += lineGap;
  doc.text(`Fat to Reduce: ${fatControl} kg`, 50, y);
  y += lineGap + 5;
...
window.bmiInsightsData = window.bmiInsightsData || [];

window.bmiInsightsData = [{
